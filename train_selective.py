...
from utils_selective import SelectiveDataset, SelectiveTrainer
...
def train(args):
    ...
    train_dataset = SelectiveDataset(args.dataset, "train", tokenizer, args.max_len, strategy, pretrain_mode=args.pretrain_mode)
    eval_dataset = SelectiveDataset(args.dataset, "eval", tokenizer, args.max_len, strategy, pretrain_mode=args.pretrain_mode)
