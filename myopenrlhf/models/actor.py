...
class Actor(nn.Module):
    ...
    def lora_init(self, aspect, lora_rank=0, lora_train_bias="none"):
        if lora_rank > 0:
    ...
    def save_pretrained(self, save_directory, global_step, aspect):
        global_step = str(global_step)
        self.model.save_pretrained(os.path.join(save_directory, aspect+'_'+global_step))
