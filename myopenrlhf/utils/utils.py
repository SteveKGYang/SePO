...
def make_mental_reward_dataset(
    datasets,
    strategy=None,
    seed=42,
    max_count=2000000,
    ...
    train_data_list = []
    eval_data_list = []
    files = {'train': datasets[0], 'validation': datasets[1]}
    data = load_dataset('csv', data_files=files)
...
#train, eval = make_mental_reward_dataset('./human_preference_data/train.csv,./human_preference_data/val.csv')
