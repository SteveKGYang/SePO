...
#from QA_dataset import SFTDataset
from myopenrlhf.models import Actor
from myopenrlhf.trainer import SFTTrainer
from myopenrlhf.utils import blending_datasets, get_strategy, get_tokenizer
...
def train(args):
    ...
    # train_dataset = SFTDataset("./QA_data/train_1k.json", tokenizer, args.max_len, strategy, pretrain_mode=args.pretrain_mode)
    # eval_dataset = SFTDataset("./QA_data/dev.json", tokenizer, args.max_len, strategy, pretrain_mode=args.pretrain_mode)
    ...
    if args.save_hf_model:
        ...
        strategy.save_hf_format(model.model, tokenizer, args.save_path + "/sft_hf")
